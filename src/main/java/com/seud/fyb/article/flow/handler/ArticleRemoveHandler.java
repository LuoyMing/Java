...
@Service("articleRemoveHandler")
public class ArticleRemoveHandler implements IWorkFLowExecuteHandler {
	...
	public boolean approvedfinishedUserChange(Map<String, Object> execVriables) {
		...
		try {
			...
			return consultContentService.removeContentAuditPass(aaoEo);
